...
#
# Gates: no context-dump separator lines; no whitespace-only lines; LF endings with exactly one
# final newline; MSBuild and solution XML parses; YAML parses. See DOCUMENTATION_REVIEW.md F-40
# and F-41 for why each is here.
#
